...
public class POController {
	...
	@GetMapping("/deletePoRequest/{poRequestId}")
	public ResponseEntity<String> deletePOItemListData(@PathVariable final int poRequestId) {
		String status = "failure";
		try {
			status = poRequestService.deletePOList(poRequestId);
			} catch (Exception e) {
